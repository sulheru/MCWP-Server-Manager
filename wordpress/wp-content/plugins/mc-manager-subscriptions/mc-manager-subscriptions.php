...
define('OPTIGRID_SUBSCRIPTIONS_VERSION', '0.12.0');
...
$requires = [
'src/Core/Database.php','src/Core/Activator.php','src/Core/PayPalReconciler.php',
...
register_deactivation_hook(OPTIGRID_SUBSCRIPTIONS_FILE,['OptiGrid_Subscriptions_PayPal_Reconciler','unschedule']);
