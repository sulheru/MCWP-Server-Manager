...
define('OPTIGRID_SUBSCRIPTIONS_VERSION', '0.5.0');
define('OPTIGRID_SUBSCRIPTIONS_DB_VERSION', '1.0.0');
...
'src/Gateways/PaymentGatewayInterface.php','src/Gateways/GatewaySettings.php','src/Gateways/GatewayRegistry.php','src/Gateways/SandboxGateway.php',
'src/Domain/Plans/PlanRepository.php','src/Domain/Payments/PaymentResult.php','src/Domain/Payments/PaymentOrderRepository.php',
'src/Domain/Payments/PaymentTransactionRepository.php','src/Domain/Payments/PaymentEventRepository.php',
'src/Domain/Subscriptions/SubscriptionRepository.php','src/Domain/Entitlements/EntitlementRepository.php',
'src/Domain/Payments/PaymentResultProcessor.php','src/Domain/Payments/CheckoutService.php',
'src/Admin/GatewaySettingsController.php','src/Admin/SandboxCheckoutController.php','src/Public/PublicCheckoutController.php','src/Admin/AdminPage.php','src/Admin/AdminMenu.php','src/Core/Plugin.php',
];
