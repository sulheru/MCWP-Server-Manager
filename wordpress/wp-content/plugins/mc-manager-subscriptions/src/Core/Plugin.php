...
final class OptiGrid_Subscriptions_Plugin
{
    ...
    public function __construct()
    {
        ...
        $this->gateway_registry =
            new OptiGrid_Subscriptions_Gateway_Registry();

        $sandbox =
            new OptiGrid_Subscriptions_Sandbox_Gateway();

        $paypal =
            new OptiGrid_Subscriptions_PayPal_Gateway();

        $this->gateway_registry->register($sandbox);
        $this->gateway_registry->register($paypal);
        $this->gateway_registry->register_extensions();

        $plans =
            new OptiGrid_Subscriptions_Plan_Repository();

        $orders =
            new OptiGrid_Subscriptions_Payment_Order_Repository();

        $transactions =
            new OptiGrid_Subscriptions_Payment_Transaction_Repository();

        $events =
            new OptiGrid_Subscriptions_Payment_Event_Repository();

        $subscriptions =
            new OptiGrid_Subscriptions_Subscription_Repository();

        $entitlements =
            new OptiGrid_Subscriptions_Entitlement_Repository();

        $processor =
            new OptiGrid_Subscriptions_Payment_Result_Processor(
                $orders,
                $transactions,
                $events,
                $subscriptions,
        ...
        $checkout =
            new OptiGrid_Subscriptions_Checkout_Service(
                $this->gateway_registry,
                $plans,
                $orders,
                $processor
        ...
        $admin_page =
            new OptiGrid_Subscriptions_Admin_Page(
                $this->gateway_registry,
                $plans
            );

        $this->admin_menu =
            new OptiGrid_Subscriptions_Admin_Menu(
                $admin_page
            );

        $this->gateway_settings_controller =
            new OptiGrid_Subscriptions_Gateway_Settings_Controller(
                $this->gateway_registry
            );

        $this->sandbox_checkout_controller =
            new OptiGrid_Subscriptions_Sandbox_Checkout_Controller(
                $checkout
            );

        $this->public_checkout_controller =
            new OptiGrid_Subscriptions_Public_Checkout_Controller(
                $this->gateway_registry,
                $plans,
                $orders,
                $subscriptions,
        ...
        $subscription_admin_repository =
            new OptiGrid_Subscriptions_Subscription_Admin_Repository();

        $subscription_admin_service =
            new OptiGrid_Subscriptions_Subscription_Admin_Service();

        $this->subscription_manager_controller =
            new OptiGrid_Subscriptions_Subscription_Manager_Controller(
                $subscription_admin_repository,
                $subscription_admin_service
            );

        $this->plan_manager_controller =
            new OptiGrid_Subscriptions_Plan_Manager_Controller(
                new OptiGrid_Subscriptions_Plan_Admin_Repository()
            );

        $this->sandbox_portal_controller =
            new OptiGrid_Subscriptions_Sandbox_Portal_Controller(
                $orders,
                $plans,
                $checkout
            );

        $this->sandbox_payments_controller =
            new OptiGrid_Subscriptions_Sandbox_Payments_Controller(
                $orders,
                $checkout
            );

        $this->paypal_return_controller =
            new OptiGrid_Subscriptions_PayPal_Return_Controller(
                $orders,
                $checkout,
                $paypal
            );
    ...
    public function run(): void
    {
        add_action(
            'admin_init',
            ['OptiGrid_Subscriptions_Database','maybe_upgrade'],
            5
        );
